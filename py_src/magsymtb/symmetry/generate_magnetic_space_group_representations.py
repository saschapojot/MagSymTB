...
from magsymtb.name_conventions import symmetry_matrices_file_name,representations_all_file_name
...
# ==============================================================================
def generate_representations(parsed_config, tol=1e-7):
    """
    Main entry point for generating magnetic space group representations.
    Replaces the old stdin/exit logic.
    """
    try:
        ...
        raise FileNotFoundError(f"Error: Symmetry matrices file not found at {symmetry_matrices_file_name_path}")
    except KeyError as e:
        raise KeyError(f"Error: Missing required key in configuration: {e}")
