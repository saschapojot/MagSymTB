...
# ==============================================================================
#  Define matrix validation function
# ==============================================================================
...
# ==============================================================================
# Define Consistency Check Functions
# ==============================================================================
...
def run_sanity_check(parsed_config):
    """
    Main entry point for sanity checks. Replaces the old stdin/exit logic.
    """
    # ==============================================================================
    ...
    if 'lattice_basis' not in parsed_config or not parsed_config['lattice_basis']:
        raise ValueError("Error: Missing or empty required field 'lattice_basis'")
    ...
    if not is_dim_valid:
        raise ValueError(f"Error: {dim_error_msg}")
    ...
    #     raise ValueError(f"Error: {wyckoff_error_msg}")
